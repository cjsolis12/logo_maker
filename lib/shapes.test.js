...
describe('generateSvg', () =>{
    test('renders a circle with user choice of color', () =>{
        ...
        shape.setColor("blue");
        expect(generateSvg(shape)).toEqual('<svg width="300" height="200"><circle cx="50%" cy="50%" r="20" fill="blue"/><text x="50%" y="50%" text-anchor="middle" dominant-baseline="central" fill="red">cjs</text></svg>')
    });
