...
class Circle extends Shape {
    ...
    render(){
        return `<svg viewBox="0 0 100 100" width="300" height="200"><circle cx="50%" cy="50%" r="20" fill="${this.shapeColor}"/><text x="50%" y="50%" text-anchor="middle" dominant-baseline="central" fill="${this.textColor}">${this.text}</text></svg>`
    }
}
