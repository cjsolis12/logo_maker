class Shape{
    ...
    static setColor(shapeInstance, shapeColor){
        shapeInstance.shapeColor = shapeColor
    }
    render(){
...
const generateSvg = ({text, textColor, shape, shapeColor}) =>{
    ...
    switch(shape){
        case "circle":
            ...
            Circle.setColor(shapeInstance, shapeColor);
            break;
        case "square":
            shapeInstance = new Square(text, textColor, shapeColor, shape);
            Square.setColor(shapeInstance, shapeColor);
            break;
        case "triangle":
            shapeInstance = new Triangle(text, textColor, shapeColor, shape);
            Triangle.setColor(shapeInstance, shapeColor);
            break;
           default:
